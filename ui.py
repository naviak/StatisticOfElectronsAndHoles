...
from informationdialog import InfoDialog
...
def showInfo():
    ...
    web.settings().setAttribute(QtWebEngineWidgets.QWebEngineSettings.PdfViewerEnabled, True)
    web.settings().setAttribute(QtWebEngineWidgets.QWebEngineSettings.FullScreenSupportEnabled, True)
    web.load(QtCore.QUrl("file:///info.pdf"))
    web.show()
    web.exec()
...
class Ui_Application(object):
    def setupUi(self, Application):
        ...
        self.menuMenu.addAction("Туториал", showInfo)
        self.menuMenu.addAction('О создателях', showDialog)
